...
for (let k = 0; k < 4; k++) {
  offsets[CHARIDS.FALCON_ID].nair1.id0.push(new Vec2D(-0.96,6.53));
  offsets[CHARIDS.FALCON_ID].nair1.id1.push(new Vec2D(5.72,6.28));
  offsets[CHARIDS.FALCON_ID].nair1.id2.push(new Vec2D(0.39,3.88));
}
for (let k = 0; k < 23; k++) {
  offsets[CHARIDS.FALCON_ID].nair2.id0.push(new Vec2D(-0.96,6.53));
  offsets[CHARIDS.FALCON_ID].nair2.id1.push(new Vec2D(5.72,6.28));
  offsets[CHARIDS.FALCON_ID].nair2.id2.push(new Vec2D(0.39,3.88));
}
offsets[CHARIDS.FALCON_ID].nair2.id0.push(new Vec2D(-0.91,6.6));
offsets[CHARIDS.FALCON_ID].nair2.id1.push(new Vec2D(5.50,6.57));
offsets[CHARIDS.FALCON_ID].nair2.id2.push(new Vec2D(0.42,4.01));

for (let k = 0; k < 4; k++) {
  offsets[CHARIDS.FALCON_ID].bair1.id0.push(new Vec2D(-0.02,8.00));
}
for (let k = 0; k < 12; k++) {
