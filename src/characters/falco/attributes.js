...
setHitBoxes(CHARIDS.FALCO_ID, {
  ...
  dair1 : new createHitboxObject(new createHitbox(offsets[3].dair.id0,5.156,12,290,100,10,0,0,0,1,1),new createHitbox(offsets[3].dair.id1,5.988,12,290,100,10,0,0,0,1,1)),
  dair2 : new createHitboxObject(new createHitbox(offsets[3].dair.id0,5.156,9,290,100,20,0,0,0,1,1),new createHitbox(offsets[3].dair.id1,5.988,9,290,100,20,0,0,0,1,1)),
  ...
  dtilt : new createHitboxObject(new createHitbox(offsets[3].dtilt.id0,1.953,13,75,125,25,0,0,1,1,1),new createHitbox(offsets[3].dtilt.id1,2.930,13,75,125,25,0,0,1,1,1),new createHitbox(offsets[3].dtilt.id2,3.125,13,75,125,25,0,0,1,1,1)),
  ...
  ftilt : new createHitboxObject(new createHitbox(offsets[3].ftilt.id0,2.734,9,361,100,0,0,0,1,1,1),new createHitbox(offsets[3].ftilt.id1,3.125,9,361,100,0,0,0,1,1,1),new createHitbox(offsets[3].ftilt.id2,2.344,9,361,100,0,0,0,1,1,1)),
  ...
  fsmash1 : new createHitboxObject(new createHitbox(offsets[3].fsmash1.id0,3.515,17,361,90,40,0,0,1,1,1),new createHitbox(offsets[3].fsmash1.id1,3.125,17,361,90,40,0,0,1,1,1),new createHitbox(offsets[3].fsmash1.id2,2.344,17,110,90,40,0,0,1,1,1)),
  fsmash2 : new createHitboxObject(new createHitbox(offsets[3].fsmash2.id0,3.515,14,361,105,10,0,0,1,1,1),new createHitbox(offsets[3].fsmash2.id1,3.125,14,361,105,10,0,0,1,1,1),new createHitbox(offsets[3].fsmash2.id2,2.344,14,361,105,10,0,0,1,1,1)),
  ...
  dsmash : new createHitboxObject(new createHitbox(offsets[3].dsmash.id0,4.687,16,25,70,20,0,0,1,1,1),new createHitbox(offsets[3].dsmash.id1,4.687,16,25,70,20,0,0,1,1,1),new createHitbox(offsets[3].dsmash.id2,3.515,13,80,70,20,0,0,1,1,1),new createHitbox(offsets[3].dsmash.id3,3.515,13,80,70,20,0,0,1,1,1)),
  ...
  downspecial : new createHitboxObject(new createHitbox(offsets[3].downspecial.id0,5.999,8,84,50,110,0,4,0,1,1)),
