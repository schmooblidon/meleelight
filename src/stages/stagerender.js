...
window.drawStageInit = function() {
  ...
  for (var j = 0; j < stage.ground.length; j++) {
    fg1.beginPath();
    fg1.moveTo((stage.ground[j][0].x * stage.scale) + stage.offset[0], (stage.ground[j][0].y * -stage.scale) + stage.offset[
      1]);
    fg1.lineTo((stage.ground[j][1].x * stage.scale) + stage.offset[0], (stage.ground[j][1].y * -stage.scale) + stage.offset[
      1]);
    fg1.closePath();
    fg1.stroke();
  }
  ...
  for (var j = 0; j < stage.ceiling.length; j++) {
    fg1.beginPath();
    fg1.moveTo((stage.ceiling[j][0].x * stage.scale) + stage.offset[0], (stage.ceiling[j][0].y * -stage.scale) +
      stage.offset[1]);
    fg1.lineTo((stage.ceiling[j][1].x * stage.scale) + stage.offset[0], (stage.ceiling[j][1].y * -stage.scale) +
      stage.offset[1]);
    fg1.closePath();
    fg1.stroke();
  }
  ...
  for (var j = 0; j < stage.platform.length; j++) {
    if (j != stage.movingPlat) {
      fg1.beginPath();
      fg1.moveTo((stage.platform[j][0].x * stage.scale) + stage.offset[0], (stage.platform[j][0].y * -stage.scale) +
        stage.offset[1]);
      fg1.lineTo((stage.platform[j][1].x * stage.scale) + stage.offset[0], (stage.platform[j][1].y * -stage.scale) +
        stage.offset[1]);
      fg1.closePath();
      fg1.stroke();
    }
  ...
  for (var k = 0; k < stage.wallL.length; k++) {
    fg1.beginPath();
    fg1.moveTo((stage.wallL[k][0].x * stage.scale) + stage.offset[0], (stage.wallL[k][0].y * -stage.scale) + stage.offset[
      1]);
    fg1.lineTo((stage.wallL[k][1].x * stage.scale) + stage.offset[0], (stage.wallL[k][1].y * -stage.scale) + stage.offset[
      1]);
    fg1.closePath();
    fg1.stroke();
  }
  ...
  for (var l = 0; l < stage.wallR.length; l++) {
    fg1.beginPath();
    fg1.moveTo((stage.wallR[l][0].x * stage.scale) + stage.offset[0], (stage.wallR[l][0].y * -stage.scale) + stage.offset[
      1]);
    fg1.lineTo((stage.wallR[l][1].x * stage.scale) + stage.offset[0], (stage.wallR[l][1].y * -stage.scale) + stage.offset[
      1]);
    fg1.closePath();
    fg1.stroke();
  }
...
window.drawStage = function() {
  if (stage.movingPlat > -1) {
    ...
    fg2.beginPath();
    fg2.moveTo((stage.platform[stage.movingPlat][0].x * stage.scale) + stage.offset[0], (stage.platform[stage.movingPlat]
      [0].y * -stage.scale) + stage.offset[1]);
    fg2.lineTo((stage.platform[stage.movingPlat][1].x * stage.scale) + stage.offset[0], (stage.platform[stage.movingPlat]
      [1].y * -stage.scale) + stage.offset[1]);
    fg2.closePath();
    fg2.stroke();
  }
  ...
  for (var j = 0; j < stage.box.length; j++) {
    fg2.fillRect((stage.box[j].min.x * stage.scale) + stage.offset[0], (stage.box[j].max.y * -stage.scale) + stage.offset[
        1], (stage.box[j].max.x - stage.box[j].min.x) * stage.scale, (stage.box[j].max.y - stage.box[j].min.y) *
      stage.scale);
  }
  ...
  for (var j = 0; j < stage.ledge.length; j++) {
    ...
    fg2.beginPath();
    if (e[1]) {
      fg2.moveTo(stage.box[e[0]].max.x * stage.scale + stage.offset[0], (stage.box[e[0]].max.y - Math.min(10, (stage.box[
        e[0]].max.y - stage.box[e[0]].min.y) / 2)) * -stage.scale + stage.offset[1]);
      fg2.lineTo(stage.box[e[0]].max.x * stage.scale + stage.offset[0], stage.box[e[0]].max.y * -stage.scale + stage.offset[
        1]);
      fg2.lineTo((stage.box[e[0]].max.x - Math.min(10, (stage.box[e[0]].max.x - stage.box[e[0]].min.x) / 2)) * stage.scale +
        stage.offset[0], stage.box[e[0]].max.y * -stage.scale + stage.offset[1]);
    } else {
      fg2.moveTo(stage.box[e[0]].min.x * stage.scale + stage.offset[0], (stage.box[e[0]].max.y - Math.min(10, (stage.box[
        e[0]].max.y - stage.box[e[0]].min.y) / 2)) * -stage.scale + stage.offset[1]);
      fg2.lineTo(stage.box[e[0]].min.x * stage.scale + stage.offset[0], stage.box[e[0]].max.y * -stage.scale + stage.offset[
        1]);
      fg2.lineTo((stage.box[e[0]].min.x + Math.min(10, (stage.box[e[0]].max.x - stage.box[e[0]].min.x) / 2)) * stage.scale +
        stage.offset[0], stage.box[e[0]].max.y * -stage.scale + stage.offset[1]);
    }
    fg2.closePath();
    fg2.stroke();
...
for (var p = 0; p < 20; p++) {
  ...
  bgStars[p].pos = new Vec2D(600 + 100 * Math.random() * bgStars[p].velocity.x, 375 + 100 * Math.random() * bgStars[p].velocity
    .y);
}
let bgSparkle = 3;
...
window.drawStars = function() {
  ...
  for (var p = 0; p < 20; p++) {
    if (bgStars[p].pos.x > 1250 || bgStars[p].pos.y > 800 || bgStars[p].pos.x < -50 || bgStars[p].pos.y < -50) {
      ...
      bgStars[p].life = 0;
      var vSeed = Math.random();
      bgStars[p].velocity = new Vec2D(5 * vSeed * Math.sign(0.5 - Math.random()), 5 * (1 - vSeed) * Math.sign(0.5 -
        Math.random()));
    }
    ...
    for (var j = 0; j < 9; j++) {
      ...
      switch (j) {
        case 0:
          ...
          break;
        case 1:
          if ((direction[k][j] == 1 && bgPos[k][j] > 550 - k * 100) || (direction[k][j] == -1 && bgPos[k][j] < 450 -
              k * 100)) {
            direction[k][j] *= -1;
          }
          break;
