...
export default {
  ...
  wallL: [[new Vec2D(-85.6, 0), new Vec2D(-85.6, -10)], [new Vec2D(-85.6, -10), new Vec2D(-65, -20)], [new Vec2D(-65, -20), new Vec2D(-65, -30)], [new Vec2D(-65, -30), new Vec2D(-55, -47)], [new Vec2D(-55, -47), new Vec2D(-50, -55)] ],
  wallR: [[new Vec2D(85.6, 0), new Vec2D(85.6, -10)], [new Vec2D(85.6, -10), new Vec2D(65, -20)], [new Vec2D(65, -20), new Vec2D(65, -30)], [new Vec2D(65, -30), new Vec2D(55, -47)], [new Vec2D(55, -47), new Vec2D(50, -55)] ],
