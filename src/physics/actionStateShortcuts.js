...
window.checkForSpecials = function(p) {
  if (player[p].inputs.b[0] && !player[p].inputs.b[1]) {
    if (player[p].phys.grounded) {
      if (Math.abs(player[p].inputs.lStickAxis[0].x) > 0.55 || (player[p].inputs.lStickAxis[0].y > 0.55 && Math.abs(
          player[p].inputs.lStickAxis[0].x) > player[p].inputs.lStickAxis[0].y - 0.2)) {
        player[p].phys.face = Math.sign(player[p].inputs.lStickAxis[0].x);
        return [true, "SIDESPECIALGROUND"];
      } else if (player[p].inputs.lStickAxis[0].y > 0.55) {
      ...
      if (player[p].inputs.lStickAxis[0].y > 0.55 || (Math.abs(player[p].inputs.lStickAxis[0].x) > 0.55 && player[p].inputs
          .lStickAxis[0].y > Math.abs(player[p].inputs.lStickAxis[0].x) - 0.2)) {
        return [true, "UPSPECIAL"];
      } else if (player[p].inputs.lStickAxis[0].y < -0.55 || (Math.abs(player[p].inputs.lStickAxis[0].x) > 0.55 && -
          player[p].inputs.lStickAxis[0].y > Math.abs(player[p].inputs.lStickAxis[0].x) - 0.2)) {
        return [true, "DOWNSPECIALAIR"];
      } else if (Math.abs(player[p].inputs.lStickAxis[0].x) > 0.55) {
        player[p].phys.face = Math.sign(player[p].inputs.lStickAxis[0].x);
...
window.checkForDash = function(p) {
  if (player[p].inputs.lStickAxis[0].x * player[p].phys.face > 0.79 && player[p].inputs.lStickAxis[2].x * player[p].phys
    .face < 0.3) {
    return true;
  } else {
    return false;
